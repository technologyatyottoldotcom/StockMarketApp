...
export class StockWatch extends React.PureComponent {
    ...
    render() {
        ...
        {
            return (
                <div className="Stock__watch__item" onClick={e=> {this.props.selectedStock(this.props.config);this.props.handleSelection()}}>
                    <div>
                        <p className="Stock__watch__name">{stocksymbol}</p>
                        <p className="Stock__watch__fullname">{company}</p>
                    </div>
        ...
        {
            return <div className="Stock__watch__item loader">
                <Pulse />
            </div>
        }
    }
